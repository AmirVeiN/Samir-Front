          ...
          <div className="flex justify-between items-end flex-col w-[70%] ">
            ...
            <div className="flex flex-row items-end justify-end w-[70] pt-2">
              <p className="text-right text-sm text-slate-400">
                فروشگاه پی سی کالا وابسته به گروه مهندسی لعل فام با بیش از ۱۵
                سال سابقه فعالیت در زمینه قطعات کامپیوتر و حوزه دیجیتال برآن شده
                است تا برای سهولت حال مشتریان عزیز براساس فعالیت های آنها و
                میزان کارایی هر سیستم متناسب با فعالیت؛ قطعات را به صورت بهینه
                شده اسمبل کرده و در اختیار مشتریان عزیز قرار دهد. تا آنها برای
                خرید یک سیستم کامل و مناسب با فعالیت کاریشان دچار مشکل نباشند و
                در اسرع وقت به خواسته خود برسند. تمام تلاش ما رضایت شما و سهولت
